...
export default function MultiCurrencyList({
  ...
  const isFavorited = favorited.some(
    (favorite) =>
      favorite.favoritedSend === currency ||
      favorite.favoritedReceive === currency,
  );
        ...
        <div>
          {!isFavorited ? (
            ...
            >
              ...
              />
              <path
                d="M15.3325 10.4108C15.6137 9.84831 16.4106 9.87175 16.6684 10.4108L18.2153 13.528L21.6372 14.0202C22.2465 14.1139 22.4809 14.8639 22.0356 15.3093L19.5747 17.7233L20.1606 21.1218C20.2544 21.7311 19.5981 22.1999 19.059 21.9186L16.0122 20.3014L12.9419 21.9186C12.4028 22.1999 11.7465 21.7311 11.8403 21.1218L12.4262 17.7233L9.96529 15.3093C9.51998 14.8639 9.75436 14.1139 10.3637 14.0202L13.809 13.528L15.3325 10.4108Z"
                fill="#CEF739"
              />
            </svg>
          )}
